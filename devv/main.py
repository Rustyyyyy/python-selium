...
p = getpass.getpass(prompt="enter pass: ")
chromedriver_path = '/home/rusty/selium/chromedriver/chromedriver' # Change this to your own chromedriver path!
...
hashtag_list = ['programming', 'hacking', 'cybersecurity']
